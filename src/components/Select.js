...
// It needs to read the city-list array to gain the data from it dynamically into the select options.
...
const Select = props => (
  <form onSubmit={props.submit}>
    <select id="select-city" onChange={props.change}>
      ...
      {/* This part iterates on the array of the city datas and gain the values from it. */}
      {cities.map(city => (
